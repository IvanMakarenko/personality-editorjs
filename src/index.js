...
export default class Personality {
  ...
  constructor({ data, config, api }) {
    ...
    this.config = {
      ...
      namePlaceholder: this.api.i18n.t('Name'),
      descriptionPlaceholder: this.api.i18n.t('Description'),
      linkPlaceholder: this.api.i18n.t('Link'),
      photoCaptionPlaceholder: this.api.i18n.t('Caption'),
      photoSubCaptionPlaceholder: this.api.i18n.t('Sub Caption'),
